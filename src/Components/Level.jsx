...
const Level = ({ level, hookSetLevel }) => {
  const [index, setIndex] = useState(0);
  const [score, setScore] = useState(48);
  //const [level, setLevel] = useState(10); this state has been lifted up to the parent component
  //const [answer, setAnswer] = useState(null); 
  //answer is of type number: don't initialize a primitive type to null in react
  ...
  const reset = () => {
    ...
    //setLevel("1"); better to keep the value the same: since level is of type number, "1" which is a string is not appropriate
    hookSetLevel(1)
  };
